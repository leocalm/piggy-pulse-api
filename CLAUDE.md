...
**Description:** A high-performance Rust backend for PiggyPulse, a personal budgeting tool.
...
1.  **Environment Variables:**
    *   `DATABASE_URL`: `postgres://user:password@localhost:5432/piggy_pulse_db`
...
| Section | Key | Default |
|---|---|---|
| `[database]` | `url` | `postgres://localhost/piggy_pulse_db` |
| | `max_connections` | 16 |
| | `min_connections` | 4 |
| `[server]` | `port` | 8000 |
| `[logging]` | `level` | `info` |
...
*   **Location:** `/opt/piggypulse/piggy-pulse`.
